...
const { dbModel } = require('../../db_model/hcp/adjustmentType.js');

async function list(user) {
	console.log('DB:adjustmentType.list(user)');
...
async function get(user, id) {
	console.log('DB:adjustmentType.get(user, id)');
	//console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:adjustmentType.update(user, id, data)');
	...
	const stmt = updateSqlStatement(user, dbModel, id, data);
	//console.log(stmt);
...
async function insert(user, data) {
	console.log('DB:adjustmentType.insert(user, data)');
	...
	const stmt = insertSqlStatement(user, dbModel, data);
	//console.log(stmt);
...
async function remove(user, id) {
	console.log('DB:adjustmentType.remove(user, id)');
	...
	const stmt = removeSqlStatement(user, dbModel, id);
	//console.log(stmt);
	const result = await database.simpleExecute(stmt);
	//console.log(result);
	return result;
