...
const { dbModel } = require('../../db_model/hcp/clientContributionType.js');

async function list(user) {
	console.log('DB:clientContributionType.list(user)');
	let query = ``;
...
async function get(user, id) {
	console.log('DB:clientContributionType.get(user, id)');
	console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:clientContributionType.update(user, id, data)');
...
async function insert(user, data) {
	console.log('DB:clientContributionType.insert(user, data)');
...
async function remove(user, id) {
	console.log('DB:clientContributionType.remove(user, id)');
