...
const { dbModel } = require('../../db_model/hcp/inboundType.js');

async function list(user) {
	console.log('DB:inboundType.list(user)');
	let query = ``;
...
async function get(user, id) {
	console.log('DB:inboundType.get(user, id)');
	console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:inboundType.update(user, id, data)');
...
async function insert(user, data) {
	console.log('DB:inboundType.insert(user, data)');
...
async function remove(user, id) {
	console.log('DB:inboundType.remove(user, id)');
