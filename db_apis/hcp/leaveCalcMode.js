...
const { dbModel } = require('../../db_model/hcp/leaveCalcMode.js');

async function list(user) {
	console.log('DB:leaveCalcMode.list(user)');
	let query = ``;
...
async function get(user, id) {
	console.log('DB:leaveCalcMode.get(user, id)');
	console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:leaveCalcMode.update(user, id, data)');
...
async function insert(user, data) {
	console.log('DB:leaveCalcMode.insert(user, data)');
...
async function remove(user, id) {
	console.log('DB:leaveCalcMode.remove(user, id)');
