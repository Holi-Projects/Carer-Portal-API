...
const { dbModel } = require('../../db_model/hcp/leaveType.js');

async function list(user) {
	console.log('DB:leaveType.list(user)');
	let query = ``;
...
async function get(user, id) {
	console.log('DB:leaveType.get(user, id)');
	console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:leaveType.update(user, id, data)');
...
async function insert(user, data) {
	console.log('DB:leaveType.insert(user, data)');
...
async function remove(user, id) {
	console.log('DB:leaveType.remove(user, id)');
