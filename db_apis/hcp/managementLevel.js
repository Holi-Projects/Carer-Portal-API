...
const { dbModel } = require('../../db_model/hcp/managementLevel.js');

async function list(user) {
	console.log('DB:managementLevel.list(user)');
	let query = ``;
...
async function get(user, id) {
	console.log('DB:managementLevel.get(user, id)');
	console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:managementLevel.update(user, id, data)');
...
async function insert(user, data) {
	console.log('DB:managementLevel.insert(user, data)');
...
async function remove(user, id) {
	console.log('DB:managementLevel.remove(user, id)');
