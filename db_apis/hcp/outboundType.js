...
const { dbModel } = require('../../db_model/hcp/outboundType.js');

async function list(user) {
	console.log('DB:outboundType.list(user)');
	let query = ``;
...
async function get(user, id) {
	console.log('DB:outboundType.get(user, id)');
	console.log(`id: ${id}`);
...
async function update(user, id, data) {
	console.log('DB:outboundType.update(user, id, data)');
...
async function insert(user, data) {
	console.log('DB:outboundType.insert(user, data)');
...
async function remove(user, id) {
	console.log('DB:outboundType.remove(user, id)');
